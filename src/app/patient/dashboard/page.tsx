...
import {
  getCurrentUser,
  logoutUser,
} from "../../../services/patient/authServices";
          ...
          <div className="container mx-auto flex items-center justify-between">
            <div className="flex items-center space-x-6">
              <Link href="/" className="flex items-center space-x-2 group">
                ...
                <span className="text-xl font-bold text-zinc-900 dark:text-white group-hover:text-purple-600 transition-colors duration-300">
                  HealSync
                </span>
              </Link>
                    ...
                    >
                      {metric.trend === "improving" && (
                        <span className="flex items-center">
                          Improving <Activity className="ml-1 h-4 w-4" />
                        </span>
                      )}
                      {metric.trend === "declining" && (
                        <span className="flex items-center">
                          Declining <Activity className="ml-1 h-4 w-4" />
                        </span>
                      )}
                      {metric.trend === "stable" && (
                        <span className="flex items-center">
                          Stable <Activity className="ml-1 h-4 w-4" />
                        </span>
                      )}
                    </div>
                  </div>
